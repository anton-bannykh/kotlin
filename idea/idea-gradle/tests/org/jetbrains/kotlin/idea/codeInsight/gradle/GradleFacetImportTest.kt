...
class GradleFacetImportTest : GradleImportingTestCase() {
    ...
    fun testJvmImport() {
        ...
        with(facetSettings) {
            ...
            Assert.assertEquals(JvmIdeTargetPlatformKind.Platform(JvmTarget.JVM_1_8), targetPlatformKind)
        ...
        with(testFacetSettings) {
            ...
            Assert.assertFalse(compilerArguments!!.autoAdvanceLanguageVersion)
            Assert.assertFalse(compilerArguments!!.autoAdvanceApiVersion)
            Assert.assertEquals(JvmIdeTargetPlatformKind.Platform(JvmTarget.JVM_1_6), targetPlatformKind)
...
compileTestKotlin {
    ...
    fun testCommonImportByPlatformPlugin() {
        ...
        with(facetSettings) {
            Assert.assertEquals("1.1", languageLevel!!.versionString)
            Assert.assertEquals("1.1", apiLevel!!.versionString)
            Assert.assertTrue(targetPlatformKind.isCommon)
        }

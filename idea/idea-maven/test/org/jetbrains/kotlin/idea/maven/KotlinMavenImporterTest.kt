...
class KotlinMavenImporterTest : MavenImportingTestCase() {
    ...
    fun testJsFacetConfiguration() {
        ...
        with(facetSettings) {
            ...
            Assert.assertEquals(true, compilerArguments!!.suppressWarnings)
            Assert.assertEquals(LanguageFeature.State.ENABLED, coroutineSupport)
            Assert.assertTrue(targetPlatformKind.isJavaScript)
    ...
    fun testJvmDetectionByGoalWithJvmStdlib() {
        ...
        Assert.assertEquals(JvmIdeTargetPlatformKind.Platform(JvmTarget.JVM_1_6), facetSettings.targetPlatformKind)
    ...
    fun testJsDetectionByGoalWithJvmStdlib() {
        ...
        Assert.assertTrue(facetSettings.targetPlatformKind.isJavaScript)
    ...
    fun testCommonDetectionByGoalWithJvmStdlib() {
        ...
        Assert.assertTrue(facetSettings.targetPlatformKind.isCommon)
    ...
    fun testMultiModuleImport() {
        ...
        with(facetSettings("my-common-module1")) {
            Assert.assertEquals(CommonIdeTargetPlatformKind.Platform.description, targetPlatformKind!!.description)
        }
        ...
        with(facetSettings("my-jvm-module")) {
            Assert.assertEquals(JvmIdeTargetPlatformKind.Platform(JvmTarget.JVM_1_6).description, targetPlatformKind!!.description)
            Assert.assertEquals(listOf("my-common-module1", "my-common-module2"), implementedModuleNames)
        }

        with(facetSettings("my-js-module")) {
            Assert.assertEquals(JsIdeTargetPlatformKind.Platform.description, targetPlatformKind!!.description)

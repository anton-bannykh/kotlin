...
class Psi2IrTranslator(
    ...
    fun generateModuleFragment(context: GeneratorContext, ktFiles: Collection<KtFile>, deserializer: IrDeserializer? = null, allowUnbound: Boolean = false): IrModuleFragment {

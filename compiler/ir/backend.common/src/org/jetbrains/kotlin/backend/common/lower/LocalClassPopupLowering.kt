    ...
    override fun lower(irBody: IrBody, container: IrDeclaration) {
        ...
        irBody.transform(object : IrElementTransformerVoidWithContext() {
            ...
            override fun visitClassNew(declaration: IrClass): IrStatement {
                ...
                val currentScope = if (allScopes.size > 1) allScopes[allScopes.lastIndex - 1] else createScope(container as IrSymbolOwner)
        ...
        for ((local, newContainer) in extractedLocalClasses) {
            ...
            // TODO
            (local as IrClassImpl).loweredUpTo = stageController.currentStage
        }
    }

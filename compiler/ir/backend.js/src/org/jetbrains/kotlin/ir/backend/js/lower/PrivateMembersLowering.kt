...
private var IrFunction.correspondingStatic by mapping<IrFunction, IrSimpleFunction>()
...
class PrivateMembersLowering(val context: JsIrBackendContext) : DeclarationTransformer {
    ...
    private fun transformAccessor(accessor: IrSimpleFunction) =
        transformMemberToStaticFunction(accessor)?.also { accessor.correspondingStatic = it } ?: accessor

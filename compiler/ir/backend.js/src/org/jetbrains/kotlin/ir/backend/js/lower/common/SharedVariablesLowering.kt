        ...
        private fun rewriteSharedVariables() {
            ...
            irFunction.transformChildrenVoid(object : IrElementTransformerVoid() {
                override fun visitVariable(declaration: IrVariable): IrStatement {
                    ...
                    val newDeclaration = data.sharedVariablesManager.declareSharedVariable(declaration)
                    newDeclaration.parent = irFunction
                    transformedSymbols[declaration.symbol] = newDeclaration.symbol

                    return data.sharedVariablesManager.defineSharedValue(declaration, newDeclaration)
                }
            })
            ...
            irFunction.transformChildrenVoid(object : IrElementTransformerVoid() {
                override fun visitGetValue(expression: IrGetValue): IrExpression {
                    ...
                    return data.sharedVariablesManager.getSharedValue(newDeclaration, expression)
                }
                ...
                override fun visitSetVariable(expression: IrSetVariable): IrExpression {
                    ...
                    return data.sharedVariablesManager.setSharedValue(newDeclaration, expression)
                }

...
private var IrEnumEntry.instanceField by mapping<IrEnumEntry, IrField>()
...
class EnumClassConstructorLowering(val context: CommonBackendContext) : DeclarationTransformer {
...
private fun CommonBackendContext.fixReferencesToConstructorParameters(irClass: IrClass, body: IrBody) {
...
class EnumClassConstructorBodyTransformer(val context: CommonBackendContext) : BodyLoweringPass {
    override fun lower(irBody: IrBody, container: IrDeclaration) {
...
private var IrEnumEntry.correspondingField by mapping(object : MappingKey<IrEnumEntry, IrField>{})
